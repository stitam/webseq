...
description: >
  This vignette describes how seqdb can interact with the NCBI databases.
vignette: >
...
Accessing metadata for one assembly at a time can take quite a while if you have a large number fo queries. However, if you want to access metadata for all hits of a search term, you can follow a hybrid approach: download the metadata manually and parse it with seqdb.
